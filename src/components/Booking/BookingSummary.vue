<template>
  <v-col cols="12" md="5" xs="12">
    <v-row no-gutters>
      <v-col cols="6" sm="6" xs="12" offset-sm="3">
        <v-img
          class="pt-12 mt-12 mx-12 pl-12 mb-0 hidden-md-and-up"
          max-width="200px"
          alt="HotelJar"
          id="HotelJar"
      ...
      <v-col cols="11" md="11" sm="9" xs="11" offset-sm="1">
        <v-card
          append
        ...
        >
          ...
          <v-card-subtitle class="title-1 pt-2 pb-4" data-cy="booking-room">
            <span data-cy="booking-room-name">
              {{ bookingInfo.roomName }}
            </span>
            <span data-cy="booking-room-type">
                    ...
                    <v-row no-gutters>
                      <v-col cols="6" md="6" xs="12">
                        <div>
                          ...
                          <span
                            class="body"
                            data-cy="booking-summary-checkInTime"
                          >
                      ...
                      <v-col cols="6" md="6" xs="12">
                        <div>
                          ...
                          <span
                            class="body"
                            data-cy="booking-summary-checkOutTime"
                          >
                    ...
                    <v-row no-gutters>
                      ...
                      >
                        ...
                        <div class="pt-4" data-cy="booking-occupancy">
                          ...
                          <span
                            class="body"
                            data-cy="booking-childrenOccupancy"
                          >
              ...
              <v-col cols="12" lg="12" md="12" sm="12" class="pa-0 ma-0">
                <v-row no-gutters>
                  <v-col cols="10" lg="10" md="10" sm="12">
                    <div
                      class="mt-0 pt-4 subheading-4"
                      data-cy="booking-subtotal"
                    >
                      <span>Subtotal</span>
                    </div>
                  </v-col>
                ...
                <v-row no-gutters>
                  <v-col cols="10" lg="10" md="10" sm="12">
                    <div
                      class="mt-0 pt-4 subheading-3"
                      data-cy="booking-discount"
                    >
                      <span>Discount</span>
                    </div>
                  </v-col>
